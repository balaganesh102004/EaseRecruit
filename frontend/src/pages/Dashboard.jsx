...
import AnalyticsRecruiter from "../components/AnalyticsRecruiter";
            ...
            <ul className="sidebar_links">
              ...
              {user && user.role === "Employer" && (
                <li>
                  <button
                    onClick={() => {
                      setComponentName("InterviewSchedule");
                      setShow(!show);
                    }}
                  >
              ...
              {/* {user && user.role === "Employer" && (
                <li>
                  <button
                    onClick={() => {
                      setComponentName("hiringManager");
                      setShow(!show);
                    }}
                  >
